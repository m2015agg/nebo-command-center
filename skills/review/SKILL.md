---
name: review
description: Code Review Phase (synced from Claude Code)
user-invocable: true
...
**Auto-generated from:** `~/bibleai/.claude/commands/review.md`

This skill invokes Claude Code's `/review` command in your BibleAI project.
