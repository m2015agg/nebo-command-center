---
name: implement-a
description: Implementation Phase (Auto-Approve Mode)
user-invocable: true
metadata: {"clawdbot":{"requires":{"bins":["claude"]}}}
---

# implement-a - Claude Code with Auto-Approve

Uses nebo-command-center with **automatic approval enabled** - no manual intervention needed.
