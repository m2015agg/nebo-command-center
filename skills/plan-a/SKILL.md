---
name: plan-a
description: Planning Phase (Auto-Approve Mode)
user-invocable: true
metadata: {"clawdbot":{"requires":{"bins":["claude"]}}}
---

# plan-a - Claude Code Planning with Auto-Approve

Invokes Claude Code's `/plan` command with **automatic approval enabled** - no manual intervention needed.
